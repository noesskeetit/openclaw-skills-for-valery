...
1. Форк → ветка `feat/your-skill` от `universal-agent-preset` (preset branch, не default `main`)
2. Коммиты — conventional (`feat: ...`, `fix: ...`, `chore: ...`)
3. PR в `universal-agent-preset`, описание по шаблону:
...
3. PR → `universal-agent-preset`, в описании — почему вычеркнули.
