...
# Extract shadcn components from tarball if available
if [ -f "$COMPONENTS_TARBALL" ]; then
  echo "Extracting shadcn/ui components..."
  tar -xzf "$COMPONENTS_TARBALL" -C src/
else
  echo "Note: shadcn-components.tar.gz not found, skipping component extraction."
  echo "You can add components manually via shadcn CLI later."
fi
...
echo ""
echo "Setup complete! Project created at: $WORKSPACE/$PROJECT_NAME"
echo ""
